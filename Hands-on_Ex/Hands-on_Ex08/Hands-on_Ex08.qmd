...
draw the dendrogram with a border around the selected clusters by using rect.hclust() of R stats
```{r}
plot(hclust_ward, cex = 0.6)
...
the groups object need to be appended onto shan_sf simple feature object.
